...
| `test/phase0_runtime_test.gleam` | Phase0 runtime | OS port/echo | `PHASE0_RUNTIME` | No | Uses real port_ffi to spawn /bin/echo or cmd.exe. |
...
- `PHASE0_RUNTIME`: disables runtime port tests by default.
