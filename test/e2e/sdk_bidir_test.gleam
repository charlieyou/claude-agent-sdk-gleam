/// E2E Tests for Bidirectional Protocol (SDK-40 to SDK-43).
///
...
/// - SDK-43: Malformed control response (offline test with mock runner)
///
/// ## Running Tests
/// ```bash
...
// ============================================================================
// SDK-42: Hook Response Timeout (E2E)
// ============================================================================
  ...
  case skip_if_no_e2e() {
    ...
    Ok(Nil) -> {
      ...
      let assert Ok(session) =
        bidir.start_with_hooks(mock.runner, config, hooks)
      complete_init(mock, session)
      should.equal(bidir.get_lifecycle(session, 1000), Running)
