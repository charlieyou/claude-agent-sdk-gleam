...
/// session's lifecycle. Used by SessionLifecycle.Failed state.
...
pub type StartError {
  ...
  /// Actor failed to start (OTP actor error).
...
// ============================================================================
// InterruptError Type (Interrupt Operation Errors)
// ============================================================================
...
/// Convert an InterruptError to a human-readable string.
pub fn interrupt_error_to_string(error: InterruptError) -> String {
  case error {
    CliError(msg) -> "CLI error: " <> msg
    InterruptTimeout -> "Interrupt request timed out"
    SessionStopped -> "Session was stopped or not running"
  }
}

// ============================================================================
// SetPermissionModeError Type
// ============================================================================
...
/// Convert a SetPermissionModeError to a human-readable string.
pub fn set_permission_mode_error_to_string(
  error: SetPermissionModeError,
) -> String {
  case error {
    SetPermissionModeCliError(msg) -> "CLI error: " <> msg
    SetPermissionModeTimeout -> "Set permission mode request timed out"
    SetPermissionModeSessionStopped -> "Session was stopped or not running"
  }
}
...
/// Convert a SetModelError to a human-readable string.
pub fn set_model_error_to_string(error: SetModelError) -> String {
  case error {
    SetModelCliError(msg) -> "CLI error: " <> msg
    SetModelTimeout -> "Set model request timed out"
    SetModelSessionStopped -> "Session was stopped or not running"
  }
}

// ============================================================================
// RewindFilesError Type
// ============================================================================
...
/// Convert a RewindFilesError to a human-readable string.
pub fn rewind_files_error_to_string(error: RewindFilesError) -> String {
  case error {
    CheckpointingNotEnabled -> "File checkpointing was not enabled"
    RewindFilesCliError(msg) -> "CLI error: " <> msg
    RewindFilesTimeout -> "Rewind files request timed out"
    RewindFilesSessionStopped -> "Session was stopped or not running"
  }
}
